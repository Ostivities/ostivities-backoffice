...
const items2: MenuProps['items'] = [
  ...
  { icon: FileSearchOutlined, title: 'Users', link: '/Dashboard/events-created' },
  { icon: PlusCircleOutlined, title: 'Audit Trail', link: '/Dashboard/create-events' },
  { icon: FieldTimeOutlined, title: "Disputes", link: "/Dashboard/coming-soon" },
